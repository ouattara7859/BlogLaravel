                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            <a href="{{route('admindashboard')}}" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="{{asset('dashboard/assets/images/logo-sm-dark.png')}}" alt="logo-sm-dark" height="22">
                                </span>
                                <span class="logo-lg">
                            ...
                            <a href="{{route('admindashboard')}}" class="logo logo-light">
                                <span class="logo-sm">
                                    <img src="{{asset('dashboard/assets/images/logo-sm-light.png')}}" alt="logo-sm-light" height="22">
                                </span>
                                <span class="logo-lg">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div>
                                                    <img src="{{asset('dashboard/assets/images/megamenu-img.png')}}" alt="megamenu-img" class="img-fluid mx-auto d-block">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="dropdown d-inline-block user-dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <form method="POST" action="{{ route('logout') }}">
                                            ...
                                            <span class="dropdown-item text-danger" ><i class="ri-shut-down-line align-middle me-1 text-danger"></i> {{ __('Log Out') }}</span>
                                            </x-dropdown-link>
                ...
                <div data-simplebar class="h-100">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                <a href="{{route('addblog')}}" class=" waves-effect">
                                    <i class="ri-calendar-2-line"></i>
                                    <span>Create Blog</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{route('allblog')}}" class=" waves-effect">
                                    <i class="ri-calendar-2-line"></i>
                                    <span>All Blog</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{route('addcategory')}}" class=" waves-effect">
                                    <i class="ri-calendar-2-line"></i>
                                    <span>Add Category</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{route('allcategory')}}" class=" waves-effect">
                                    <i class="ri-calendar-2-line"></i>
