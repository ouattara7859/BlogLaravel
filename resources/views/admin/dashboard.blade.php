                    ...
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-1 overflow-hidden">
                                <p class="text-truncate font-size-14 mb-2">Nombres Blogs</p>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-1 overflow-hidden">
                                <p class="text-truncate font-size-14 mb-2">Totals Users</p>
                            ...
                            <tbody>
                                    ...
                                    <td style="width: 60px;">
                                        <div class="avatar-xs">
                                            <div class="avatar-title rounded-circle bg-light">
                                                <img src="{{asset('dashboard/assets/images/companies/img-1.png')}}" alt="img-1" height="20">
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="avatar-xs">
                                            <div class="avatar-title rounded-circle bg-light">
                                                <img src="{{asset('dashboard/assets/images/companies/img-2.png')}}" alt="img-2" height="20">
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div class="avatar-xs">
                                            <div class="avatar-title rounded-circle bg-light">
                                                <img src="{{asset('dashboard/assets/images/companies/img-3.png')}}" alt="img-3" height="20">
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                            ...
                            <li>
                                <div class="conversation-list">
                                    <div class="chat-avatar">
                                        <img src="{{asset('dashboard/assets/images/users/avatar-2.jpg')}}" alt="avatar-2">
                                    </div>
