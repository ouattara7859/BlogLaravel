(function($) {
  ...
  if ($.fn.meanmenu) {
    $('nav#dropdown').meanmenu({
      siteLogo: "<div class='mobile-menu-nav-back'><a class='logo-mobile' href='http://127.0.0.1:8000'><img src='http://127.0.0.1:8000/user/media/logo_atlas_mobile.png' alt='logo' class='img-fluid'/></a></div>"
    });
  }
